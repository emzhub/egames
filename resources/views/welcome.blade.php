...
<div id="carousel-example-2" class="carousel slide carousel-fade z-depth-1-half" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <div class="view">
                <img class="d-block w-100" src="{{URL::asset('public/img/ronaldo1.jpg') }}" alt="First slide">
        ...
        <div class="carousel-item">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100" src="{{URL::asset('public/img/nba2k.jpg') }}" alt="Second slide">
                <div class="mask rgba-black-light"></div>
            </div>
            <div class="carousel-caption">
                <h3 class="h3-responsive">WELCOME TO ESURF GAMES</h3>
        ...
        <div class="carousel-item">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100" src="{{URL::asset('public/img/psvita.jpg') }}" alt="Third slide">
                <div class="mask rgba-black-light"></div>
            </div>
            <div class="carousel-caption">
                <h3 class="h3-responsive">WELCOME TO ESURF GAMES</h3>
           ...
           <div class="carousel-item">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100" src="{{URL::asset('public/img/shark.jpg') }}" alt="Third slide">
                <div class="mask rgba-black-light"></div>
            </div>
            <div class="carousel-caption">
                <h3 class="h3-responsive">WELCOME TO ESURF GAMES</h3>
           ...
           <div class="carousel-item">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100" src="{{URL::asset('public/img/pogba.jpg') }}" alt="Third slide">
                <div class="mask rgba-black-light"></div>
            </div>
            <div class="carousel-caption">
                <h3 class="h3-responsive">WELCOME TO ESURF GAMES</h3>
 ...
 <a class="text-success"><i class="fa fa-trophy ">&nbsp;$9.00</i></a>
   <button class="btn btn-sm btn-warning ">Play match</button>
     ...
     <div class="col-md-4">
      <br>
     <div class="card ">
         <div class="card-head mdb-color darken-3"><h5 class="card-title text-white">FIFA 18| Any teams</h5></div>
    <div class="card-body mdb-color darken-3">
       <hr>
        <p class="subcolor">ONLINE</p>
