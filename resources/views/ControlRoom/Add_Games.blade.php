...
@section('title') Add Games @endsection
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                               <form id="send-announcement-form" role="form"  method="POST" action="{{route('add_game')}}">
                                    @csrf
                                    <div id="cat_fields">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="catname[]" type="text" placeholder="Enter Game Name...." class="form-control{{ $errors->has('catname') ? ' is-invalid' : '' }}" name="catname[]" value="{{ old('catname') }}" required autofocus>
